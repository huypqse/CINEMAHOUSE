...
public enum ErrorCode {
    ...
    VNPAY_SIGNING_FAILED(400,"VNPAY_SIGNING_FAILED", HttpStatus.BAD_REQUEST),
    VNPAY_CHECKSUM_FAILED(400,"VNPAY_CHECKSUM_FAILED", HttpStatus.BAD_REQUEST),
    BILL_NOT_FOUND(404, "BILL_NOT_FOUND", HttpStatus.NOT_FOUND),
    SESSION_NOT_EXISTED(404, "SESSION_NOT_FOUND", HttpStatus.NOT_FOUND),
    MOVIE_NOT_FOUND(404, "MOVIE_NOT_FOUND", HttpStatus.NOT_FOUND),
    SEAT_BOOKED(400, "SEAT_BOOKED", HttpStatus.BAD_REQUEST),
    SEAT_NOT_FOUND(404, "SEAT_NOT_FOUND", HttpStatus.NOT_FOUND),
    MOVIE_TYPE_NOT_FOUND(404, "MOVIE_TYPE_NOT_FOUND", HttpStatus.NOT_FOUND),
    SCREENING_SESSION_NOT_FOUND(404, "SCREENING_SESSION_NOT_FOUND", HttpStatus.NOT_FOUND)
    ;
